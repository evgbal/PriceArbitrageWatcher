...
class SubscribeToCoinExUseCase @Inject constructor(
    ...
    fun start() {
        scope.launch {
            selectedPairRepository.selectedPairs
                ...
                .collectLatest { pairs ->
                    val tickers = selectedPairRepository.getCoinExTickers()
    ...
    fun getMessageFlow(): SharedFlow<String> = CoinExWebSocketClient.messageFlow
}